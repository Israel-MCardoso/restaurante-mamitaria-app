revoke execute on function public.create_canonical_order(jsonb) from anon, authenticated;
revoke execute on function public.create_canonical_order(jsonb, text, text) from anon, authenticated;
grant execute on function public.create_canonical_order(jsonb, text, text) to service_role;
